...
pub fn geocode(address: &str) -> Result<GeocodedAddress, GeocodeError> {
    Ok(GeocodedAddress { rating: 1, lon: -77.0590732421937, lat: 38.9072140041614, street_number: 1311, street: String::from("30th"), street_type: String::from("St"), city: String::from("Washington"), state: String::from("DC"), zip_code: String::from("20007") })
}
